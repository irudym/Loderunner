...
- (id)init
{
    ...
    [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile: @"fpipe-anim.plist"];
    [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile: @"fpipe.plist"];
